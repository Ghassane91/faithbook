...
| 3c.4 | **Rattrapage des captures manquees** : au demarrage, FaithBook relance les cibles dont l heure du jour est passee sans qu aucune capture n ait eu lieu. La tolerance aux retards d APScheduler ne couvrait pas ce cas : elle ne s applique qu aux taches deja enregistrees quand l echeance passe, or un arret complet de la machine les recree ensuite avec une echeance future. Une seule reprise par cible et par jour, fenetre de 20 h, desactivable. 5 tests | ✅ Fait — v1.14.0 |
